...
const List = () => {
  ...
  const handleShowModalAddCategory = React.useCallback(() => {
    setShowAddCategoryModal(true);
  }, []);

  const handleCloseAddNews = React.useCallback((id) => {
  ...
  return (
    <>
      <AddCategoryModel 
        ...
        handleCancel={handleCloseAddNews}
      />
      <div>
                    ...
                    >
                      ...
                      <td class="px-6 py-4 text-right">
                        <button
                          ...
                          onClick={() => history.push(`category/edit/${category._id}`)}
                        >
                          Cập nhật
                        </button>
                      </td>
